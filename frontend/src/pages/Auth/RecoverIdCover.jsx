...
const RecoverIdCover = () => {
    ...
    const mutation = useMutation({
        ...
        onSuccess: (response) => {
            ...
            coloredToast('success', response?.data?.message, 'top');
            // navigate('/');
        },
        onError: (error) => {
            console.log(error);
                ...
                <div className="relative flex w-full max-w-[1502px] flex-col justify-between overflow-hidden rounded-md bg-white/60 backdrop-blur-lg dark:bg-black/50 lg:min-h-[758px] lg:flex-row lg:gap-10 xl:gap-0">
                    ...
                    <div className="relative flex w-full flex-col items-center justify-center gap-6 px-4 pb-16 pt-6 sm:px-6 lg:max-w-[667px]">
                        ...
                        <div className="w-full max-w-[440px] lg:mt-16">
                            ...
                            <Formik initialValues={{ userEmail: '' }} validationSchema={validationSchema} onSubmit={submitForm}>
                                {({ isSubmitting }) => (
                                    <Form className="space-y-5">
                                        <div>
                                            <label htmlFor="userEmail">Email</label>
                                            <div className="relative text-white-dark">
                                                <Field id="userEmail" name="userEmail" type="email" placeholder="Enter Email" className="form-input pl-10 placeholder:text-white-dark" />
                                                <span className="absolute left-4 top-1/2 -translate-y-1/2">
                                                    <IconMail fill={true} />
                                                </span>
                                            </div>
